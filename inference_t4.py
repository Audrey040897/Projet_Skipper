...
def predict(file_path):
    ...
    Retourne : 0 (conduite unique) ou 1 (conduites parallèles)
    """
    ...
    print(f"Prédiction : {pred}  ({'Conduites parallèles' if pred == 1 else 'Conduite unique'})")
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage   : python inference_task4.py <chemin_vers_fichier.npz>")
        print("Exemple : python inference_task4.py Data_SNDT/parallel_02000_straight_opposite_clean_field.npz")
        sys.exit(1)
